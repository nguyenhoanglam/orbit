...
export default async function InvitePage({ params }: Props) {
  ...
  if (!invite) {
    return <InviteErrorCard title="Invalid invite" description="This invite link is invalid or has been revoked." />
  }

  if (new Date(invite.expires_at) < new Date()) {
    return <InviteErrorCard title="Invite expired" description="This invite link has expired. Ask your team admin to send a new one." />
  }
